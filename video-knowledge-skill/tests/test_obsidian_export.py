...
from scripts.obsidian_export import detect_vault, export_summary, safe_filename
...
def test_export_summary_copies_to_vault_subdir(tmp_path):
    ...
    exported = export_summary(task, vault=vault, subdir="Video Knowledge")

    assert exported == vault / "Video Knowledge" / "标题：AI Coding.md"
